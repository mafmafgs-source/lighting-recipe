...
(function (global) {
  ...
  const I18N = {
    ...
    ja: {
      ...
      addCatTile:'カテゴリ追加', tapToSet:'タップして設定', addItemRow:'機材を追加', empty:'空',
    ...
    en: {
      ...
      addCatTile:'Add Category', tapToSet:'Tap to set up', addItemRow:'Add gear', empty:'Empty',
    ...
    zh: {
      ...
      addCatTile:'添加类别', tapToSet:'点击设置', addItemRow:'添加器材', empty:'空',
    ...
    ko: {
      ...
      addCatTile:'카테고리 추가', tapToSet:'탭하여 설정', addItemRow:'장비 추가', empty:'비어 있음',
    ...
    de: {
      ...
      cats:{strobe:'Blitz',video:'Videoleuchte',video_stick:'Stableuchte',modifier:'Lichtformer',softbox:'Softbox',umbrella:'Schirm',beauty_dish:'Beauty Dish',snoot:'Snoot',stand:'Lampenstativ',boom:'Galgenstativ',reflector:'Reflektor',flag:'Flag Frame'},
      warehouseTitle:'Equipment-Lager', catPrompt:'Kategorie wählen', builderTitle:'Light Builder', saveBtn:'Speichern & zurück',
      addCatTile:'Kategorie hinzufügen', tapToSet:'Zum Einrichten tippen', addItemRow:'Equipment hinzufügen', empty:'Leer',
    ...
    fr: {
      ...
      cats:{strobe:'Flash',video:'Lampe vidéo',video_stick:'Tube lumineux',modifier:'Modeleur',softbox:'Softbox',umbrella:'Parapluie',beauty_dish:'Beauty Dish',snoot:'Snoot',stand:'Pied d’éclairage',boom:'Bras déporté',reflector:'Réflecteur',flag:'Flag Frame'},
      ...
      addCatTile:'Ajouter une catégorie', tapToSet:'Toucher pour configurer', addItemRow:'Ajouter du matériel', empty:'Vide',
    ...
    it: {
      ...
      cats:{strobe:'Flash',video:'Luce video',video_stick:'Luce a barra',modifier:'Modificatore',softbox:'Softbox',umbrella:'Ombrello',beauty_dish:'Beauty Dish',snoot:'Snoot',stand:'Stativo',boom:'Braccio',reflector:'Riflettore',flag:'Flag Frame'},
      warehouseTitle:'Magazzino attrezzatura', catPrompt:'Seleziona una categoria', builderTitle:'Light Builder', saveBtn:'Salva e torna',
      addCatTile:'Aggiungi categoria', tapToSet:'Tocca per configurare', addItemRow:'Aggiungi attrezzatura', empty:'Vuoto',
    ...
    es: {
      ...
      cats:{strobe:'Flash',video:'Luz de video',video_stick:'Luz de barra',modifier:'Modificador',softbox:'Softbox',umbrella:'Paraguas',beauty_dish:'Beauty Dish',snoot:'Snoot',stand:'Soporte de luz',boom:'Brazo jirafa',reflector:'Reflector',flag:'Flag Frame'},
      warehouseTitle:'Almacén de equipo', catPrompt:'Selecciona una categoría', builderTitle:'Light Builder', saveBtn:'Guardar y volver',
      addCatTile:'Añadir categoría', tapToSet:'Toca para configurar', addItemRow:'Añadir equipo', empty:'Vacío',
