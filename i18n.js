...
(function (global) {
  ...
  const I18N = {
    ...
    ja: {
      ...
      // builder.html
      cats:{strobe:'ストロボ',video:'ビデオライト',video_stick:'スティック型',panel:'パネル型',modifier:'モディファイア',softbox:'ソフトボックス',umbrella:'アンブレラ',beauty_dish:'ビューティーディッシュ',snoot:'スヌート',grid:'グリッド',fresnel:'フレネル',stand:'ライトスタンド',boom:'ブームアーム',reflector:'レフ板',flag:'Flag Frame',lens:'レンズ'},
    ...
    en: {
      ...
      cats:{strobe:'Strobe',video:'Video Light',video_stick:'Stick Light',panel:'Panel',modifier:'Modifier',softbox:'Softbox',umbrella:'Umbrella',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Grid',fresnel:'Fresnel',stand:'Light Stand',boom:'Boom Arm',reflector:'Reflector',flag:'Flag Frame',lens:'Lens'},
    ...
    zh: {
      ...
      cats:{strobe:'频闪灯',video:'视频灯',video_stick:'棒形灯',panel:'平板灯',modifier:'附件',softbox:'柔光箱',umbrella:'伞',beauty_dish:'美颜碟',snoot:'束光筒',grid:'蜂窝罩',fresnel:'菲涅尔',stand:'灯架',boom:'横臂',reflector:'反光板',flag:'遮光板',lens:'镜头'},
    ...
    ko: {
      ...
      cats:{strobe:'스트로브',video:'비디오라이트',video_stick:'스틱라이트',panel:'패널',modifier:'모디파이어',softbox:'소프트박스',umbrella:'우산',beauty_dish:'뷰티디쉬',snoot:'스누트',grid:'그리드',fresnel:'프레넬',stand:'라이트스탠드',boom:'붐암',reflector:'반사판',flag:'플래그프레임',lens:'렌즈'},
    ...
    de: {
      ...
      cats:{strobe:'Blitz',video:'Videoleuchte',video_stick:'Stableuchte',panel:'Panel',modifier:'Lichtformer',softbox:'Softbox',umbrella:'Schirm',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Grid',fresnel:'Fresnel',stand:'Lampenstativ',boom:'Galgenstativ',reflector:'Reflektor',flag:'Flag Frame',lens:'Objektiv'},
    ...
    fr: {
      ...
      cats:{strobe:'Flash',video:'Lampe vidéo',video_stick:'Tube lumineux',panel:'Panneau',modifier:'Modeleur',softbox:'Softbox',umbrella:'Parapluie',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Grille',fresnel:'Fresnel',stand:'Pied d’éclairage',boom:'Bras déporté',reflector:'Réflecteur',flag:'Flag Frame',lens:'Objectif'},
    ...
    it: {
      ...
      cats:{strobe:'Flash',video:'Luce video',video_stick:'Luce a barra',panel:'Pannello',modifier:'Modificatore',softbox:'Softbox',umbrella:'Ombrello',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Griglia',fresnel:'Fresnel',stand:'Stativo',boom:'Braccio',reflector:'Riflettore',flag:'Flag Frame',lens:'Obiettivo'},
    ...
    es: {
      ...
      cats:{strobe:'Flash',video:'Luz de video',video_stick:'Luz de barra',panel:'Panel',modifier:'Modificador',softbox:'Softbox',umbrella:'Paraguas',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Rejilla',fresnel:'Fresnel',stand:'Soporte de luz',boom:'Brazo jirafa',reflector:'Reflector',flag:'Flag Frame',lens:'Objetivo'},
  ...
  // ── 追加辞書30（2026-09-15 レシピ共有＝共有リンク／共有レシピ（見るだけ））─────
  const EXTRA30 = {
    ja: { inclLink:'🔗 レシピのリンクを本文に含める', shareLinkBtn:'🔗 リンクだけ共有', shareLinkNotice:'※ リンクには図・機材名・3Dの配置と、上でチェックした情報（ロケーション・撮影日・EXIF・機材費用）が入ります。写真は入りません。リンクを受け取った人は誰でも開けます', shareLinkCopied:'リンクをコピーしました', shareLinkFailed:'リンクを作れませんでした', shareLinkText:'Lighting Recipe「{t}」',
          sharedImportTitle:'🔗 レシピを読み込みますか？', sharedImportBody:'「{t}」（ライト{n}灯）を自分のレシピに保存します。共有レシピは見るだけで、編集や出力はできません。', sharedImportIncl:'含まれる情報: {list}', sharedImportYes:'読み込む', sharedImportNo:'やめる', sharedInvalid:'このリンクは読み込めませんでした', sharedSaved:'共有レシピを保存しました',
          sharedBadge:'🔗 共有', sharedViewTitle:'🔗 共有レシピ（見るだけ）', sharedViewHint:'図は動かせません。3Dでは動かして確認できます（保存はされません）', closeShared:'✕ 共有レシピを閉じる', loadFromLink:'🔗 リンクから読み込む', loadFromLinkPh:'共有リンクを貼り付けてください',
          sInclLoc:'ロケーション', sInclDate:'撮影日', sInclExif:'撮影データ', sInclPrices:'機材費用', sInclNone:'図と機材のみ' },
    en: { inclLink:'🔗 Include the recipe link in the text', shareLinkBtn:'🔗 Share link only', shareLinkNotice:'The link contains the diagram, gear names, the 3D layout and the info checked above (location, date, EXIF, gear cost). Photos are not included. Anyone with the link can open it', shareLinkCopied:'Link copied', shareLinkFailed:'Could not create the link', shareLinkText:'Lighting Recipe "{t}"',
          sharedImportTitle:'🔗 Load this recipe?', sharedImportBody:'"{t}" ({n} lights) will be saved to your recipes. Shared recipes are view-only: no editing or export.', sharedImportIncl:'Included: {list}', sharedImportYes:'Load', sharedImportNo:'Cancel', sharedInvalid:'This link could not be loaded', sharedSaved:'Shared recipe saved',
          sharedBadge:'🔗 Shared', sharedViewTitle:'🔗 Shared recipe (view only)', sharedViewHint:'The diagram is locked. In 3D you can move things to look (nothing is saved)', closeShared:'✕ Close shared recipe', loadFromLink:'🔗 Load from link', loadFromLinkPh:'Paste the shared link',
          sInclLoc:'location', sInclDate:'date', sInclExif:'shooting data', sInclPrices:'gear cost', sInclNone:'diagram and gear only' },
    zh: { inclLink:'🔗 在正文中加入配方链接', shareLinkBtn:'🔗 仅分享链接', shareLinkNotice:'链接包含布光图、器材名称、3D 布局以及上方勾选的信息（地点、日期、EXIF、器材费用）。不包含照片。任何拿到链接的人都能打开', shareLinkCopied:'已复制链接', shareLinkFailed:'无法生成链接', shareLinkText:'Lighting Recipe「{t}」',
          sharedImportTitle:'🔗 要读取这个配方吗？', sharedImportBody:'将把「{t}」（{n} 盏灯）保存到你的配方。共享配方仅供查看，不能编辑或导出。', sharedImportIncl:'包含信息：{list}', sharedImportYes:'读取', sharedImportNo:'取消', sharedInvalid:'无法读取此链接', sharedSaved:'已保存共享配方',
          sharedBadge:'🔗 共享', sharedViewTitle:'🔗 共享配方（仅查看）', sharedViewHint:'布光图已锁定。在 3D 中可以移动查看（不会保存）', closeShared:'✕ 关闭共享配方', loadFromLink:'🔗 从链接读取', loadFromLinkPh:'请粘贴共享链接',
          sInclLoc:'地点', sInclDate:'拍摄日期', sInclExif:'拍摄数据', sInclPrices:'器材费用', sInclNone:'仅布光图与器材' },
    ko: { inclLink:'🔗 본문에 레시피 링크 포함', shareLinkBtn:'🔗 링크만 공유', shareLinkNotice:'링크에는 도면·장비 이름·3D 배치와 위에서 체크한 정보(장소·촬영일·EXIF·장비 비용)가 들어갑니다. 사진은 포함되지 않습니다. 링크를 받은 사람은 누구나 열 수 있습니다', shareLinkCopied:'링크를 복사했습니다', shareLinkFailed:'링크를 만들 수 없습니다', shareLinkText:'Lighting Recipe「{t}」',
          sharedImportTitle:'🔗 레시피를 불러올까요?', sharedImportBody:'「{t}」(조명 {n}개)를 내 레시피에 저장합니다. 공유 레시피는 보기 전용이며 편집·출력할 수 없습니다.', sharedImportIncl:'포함된 정보: {list}', sharedImportYes:'불러오기', sharedImportNo:'취소', sharedInvalid:'이 링크를 불러올 수 없습니다', sharedSaved:'공유 레시피를 저장했습니다',
          sharedBadge:'🔗 공유', sharedViewTitle:'🔗 공유 레시피(보기 전용)', sharedViewHint:'도면은 움직일 수 없습니다. 3D에서는 움직여 볼 수 있습니다(저장되지 않음)', closeShared:'✕ 공유 레시피 닫기', loadFromLink:'🔗 링크에서 불러오기', loadFromLinkPh:'공유 링크를 붙여넣으세요',
          sInclLoc:'장소', sInclDate:'촬영일', sInclExif:'촬영 데이터', sInclPrices:'장비 비용', sInclNone:'도면과 장비만' },
    de: { inclLink:'🔗 Rezept-Link in den Text aufnehmen', shareLinkBtn:'🔗 Nur Link teilen', shareLinkNotice:'Der Link enthält Diagramm, Gerätenamen, 3D-Aufbau und die oben angehakten Angaben (Ort, Datum, EXIF, Gerätekosten). Fotos sind nicht enthalten. Jeder mit dem Link kann ihn öffnen', shareLinkCopied:'Link kopiert', shareLinkFailed:'Link konnte nicht erstellt werden', shareLinkText:'Lighting Recipe „{t}“',
          sharedImportTitle:'🔗 Dieses Rezept laden?', sharedImportBody:'„{t}“ ({n} Lichter) wird in deinen Rezepten gespeichert. Geteilte Rezepte sind nur zum Ansehen: kein Bearbeiten, kein Export.', sharedImportIncl:'Enthalten: {list}', sharedImportYes:'Laden', sharedImportNo:'Abbrechen', sharedInvalid:'Dieser Link konnte nicht geladen werden', sharedSaved:'Geteiltes Rezept gespeichert',
          sharedBadge:'🔗 Geteilt', sharedViewTitle:'🔗 Geteiltes Rezept (nur ansehen)', sharedViewHint:'Das Diagramm ist gesperrt. In 3D kannst du zum Ansehen verschieben (nichts wird gespeichert)', closeShared:'✕ Geteiltes Rezept schließen', loadFromLink:'🔗 Aus Link laden', loadFromLinkPh:'Geteilten Link einfügen',
          sInclLoc:'Ort', sInclDate:'Datum', sInclExif:'Aufnahmedaten', sInclPrices:'Gerätekosten', sInclNone:'nur Diagramm und Geräte' },
    fr: { inclLink:'🔗 Inclure le lien de la recette dans le texte', shareLinkBtn:'🔗 Partager le lien seul', shareLinkNotice:'Le lien contient le schéma, les noms du matériel, la disposition 3D et les infos cochées ci-dessus (lieu, date, EXIF, coût du matériel). Les photos ne sont pas incluses. Toute personne ayant le lien peut l’ouvrir', shareLinkCopied:'Lien copié', shareLinkFailed:'Impossible de créer le lien', shareLinkText:'Lighting Recipe « {t} »',
          sharedImportTitle:'🔗 Charger cette recette ?', sharedImportBody:'« {t} » ({n} lumières) sera enregistrée dans vos recettes. Les recettes partagées sont en lecture seule : ni édition ni export.', sharedImportIncl:'Inclus : {list}', sharedImportYes:'Charger', sharedImportNo:'Annuler', sharedInvalid:'Ce lien n’a pas pu être chargé', sharedSaved:'Recette partagée enregistrée',
          sharedBadge:'🔗 Partagée', sharedViewTitle:'🔗 Recette partagée (lecture seule)', sharedViewHint:'Le schéma est verrouillé. En 3D vous pouvez déplacer pour regarder (rien n’est enregistré)', closeShared:'✕ Fermer la recette partagée', loadFromLink:'🔗 Charger depuis un lien', loadFromLinkPh:'Collez le lien partagé',
          sInclLoc:'lieu', sInclDate:'date', sInclExif:'données de prise de vue', sInclPrices:'coût du matériel', sInclNone:'schéma et matériel seulement' },
    it: { inclLink:'🔗 Includi il link della ricetta nel testo', shareLinkBtn:'🔗 Condividi solo il link', shareLinkNotice:'Il link contiene lo schema, i nomi dell’attrezzatura, la disposizione 3D e le informazioni selezionate sopra (luogo, data, EXIF, costo attrezzatura). Le foto non sono incluse. Chiunque abbia il link può aprirlo', shareLinkCopied:'Link copiato', shareLinkFailed:'Impossibile creare il link', shareLinkText:'Lighting Recipe “{t}”',
          sharedImportTitle:'🔗 Caricare questa ricetta?', sharedImportBody:'“{t}” ({n} luci) verrà salvata nelle tue ricette. Le ricette condivise sono di sola lettura: niente modifiche né esportazione.', sharedImportIncl:'Incluso: {list}', sharedImportYes:'Carica', sharedImportNo:'Annulla', sharedInvalid:'Impossibile caricare questo link', sharedSaved:'Ricetta condivisa salvata',
          sharedBadge:'🔗 Condivisa', sharedViewTitle:'🔗 Ricetta condivisa (sola lettura)', sharedViewHint:'Lo schema è bloccato. In 3D puoi spostare per guardare (nulla viene salvato)', closeShared:'✕ Chiudi ricetta condivisa', loadFromLink:'🔗 Carica da link', loadFromLinkPh:'Incolla il link condiviso',
          sInclLoc:'luogo', sInclDate:'data', sInclExif:'dati di scatto', sInclPrices:'costo attrezzatura', sInclNone:'solo schema e attrezzatura' },
    es: { inclLink:'🔗 Incluir el enlace de la receta en el texto', shareLinkBtn:'🔗 Compartir solo el enlace', shareLinkNotice:'El enlace contiene el esquema, los nombres del equipo, la disposición 3D y la información marcada arriba (lugar, fecha, EXIF, coste del equipo). No incluye fotos. Cualquiera con el enlace puede abrirlo', shareLinkCopied:'Enlace copiado', shareLinkFailed:'No se pudo crear el enlace', shareLinkText:'Lighting Recipe «{t}»',
          sharedImportTitle:'🔗 ¿Cargar esta receta?', sharedImportBody:'«{t}» ({n} luces) se guardará en tus recetas. Las recetas compartidas son solo de lectura: sin edición ni exportación.', sharedImportIncl:'Incluye: {list}', sharedImportYes:'Cargar', sharedImportNo:'Cancelar', sharedInvalid:'No se pudo cargar este enlace', sharedSaved:'Receta compartida guardada',
          sharedBadge:'🔗 Compartida', sharedViewTitle:'🔗 Receta compartida (solo lectura)', sharedViewHint:'El esquema está bloqueado. En 3D puedes mover para mirar (no se guarda nada)', closeShared:'✕ Cerrar receta compartida', loadFromLink:'🔗 Cargar desde enlace', loadFromLinkPh:'Pega el enlace compartido',
          sInclLoc:'lugar', sInclDate:'fecha', sInclExif:'datos de toma', sInclPrices:'coste del equipo', sInclNone:'solo esquema y equipo' }
  };
  for (const k in EXTRA30) { if (I18N[k]) Object.assign(I18N[k], EXTRA30[k]); }
  // ⭐9/16 出力画像の QR（画像から読み込む）
  const EXTRA31 = {
    ja: { inclQr:'🔳 QRコードを画像に載せる', qrNotice:'※ 保存した画像をマイページの「画像から読み込む」で選ぶと、このレシピを取り込めます（QRは短縮リンク。圏外などで作れないときは載りません）', qrFooterTitle:'この画像からレシピを開けます', qrFooterText:'画像を保存して、Lighting Recipe のマイページ「画像から読み込む」で選んでください。スマホのカメラで QR を読んでも開けます。', qrSkipped:'QRコードは載せられませんでした（リンクを作れません）', loadFromImage:'🖼 画像から読み込む', qrNotFound:'QRコードが見つかりませんでした' },
    en: { inclQr:'🔳 Put a QR code on the image', qrNotice:'Pick the saved image with "Load from image" on My Page to import this recipe (the QR holds a short link; it is skipped when the link cannot be created, e.g. offline)', qrFooterTitle:'Open this recipe from the image', qrFooterText:'Save the image and pick it with "Load from image" on the Lighting Recipe My Page. Scanning the QR with your phone camera also works.', qrSkipped:'The QR code was skipped (could not create the link)', loadFromImage:'🖼 Load from image', qrNotFound:'No QR code found' },
    zh: { inclQr:'🔳 在图片上放置二维码', qrNotice:'在“我的页面”的“从图片读取”中选择保存的图片即可导入此配方（二维码为短链接；离线等无法生成时不会放置）', qrFooterTitle:'可从此图片打开配方', qrFooterText:'保存图片，然后在 Lighting Recipe 的“我的页面”中用“从图片读取”选择它。用手机相机扫描二维码也可以打开。', qrSkipped:'未能放置二维码（无法生成链接）', loadFromImage:'🖼 从图片读取', qrNotFound:'未找到二维码' },
    ko: { inclQr:'🔳 이미지에 QR 코드 넣기', qrNotice:'저장한 이미지를 마이페이지의 "이미지에서 불러오기"로 선택하면 이 레시피를 가져올 수 있습니다(QR은 짧은 링크. 오프라인 등으로 만들 수 없으면 넣지 않습니다)', qrFooterTitle:'이 이미지에서 레시피를 열 수 있습니다', qrFooterText:'이미지를 저장한 뒤 Lighting Recipe 마이페이지의 "이미지에서 불러오기"로 선택하세요. 휴대폰 카메라로 QR을 읽어도 열립니다.', qrSkipped:'QR 코드를 넣지 못했습니다(링크를 만들 수 없음)', loadFromImage:'🖼 이미지에서 불러오기', qrNotFound:'QR 코드를 찾을 수 없습니다' },
    de: { inclQr:'🔳 QR-Code auf das Bild setzen', qrNotice:'Wähle das gespeicherte Bild unter „Aus Bild laden“ auf Meine Seite, um dieses Rezept zu importieren (der QR enthält einen Kurzlink; ohne Verbindung wird er weggelassen)', qrFooterTitle:'Dieses Rezept aus dem Bild öffnen', qrFooterText:'Bild speichern und auf der Lighting-Recipe-Seite „Meine Seite“ mit „Aus Bild laden“ auswählen. Den QR mit der Handykamera zu scannen funktioniert ebenfalls.', qrSkipped:'QR-Code weggelassen (Link konnte nicht erstellt werden)', loadFromImage:'🖼 Aus Bild laden', qrNotFound:'Kein QR-Code gefunden' },
    fr: { inclQr:'🔳 Ajouter un QR code sur l’image', qrNotice:'Choisissez l’image enregistrée avec « Charger depuis une image » sur Ma page pour importer cette recette (le QR contient un lien court ; il est omis s’il ne peut pas être créé, par ex. hors ligne)', qrFooterTitle:'Ouvrir cette recette depuis l’image', qrFooterText:'Enregistrez l’image puis choisissez-la avec « Charger depuis une image » sur Ma page de Lighting Recipe. Scanner le QR avec l’appareil photo du téléphone fonctionne aussi.', qrSkipped:'QR code omis (impossible de créer le lien)', loadFromImage:'🖼 Charger depuis une image', qrNotFound:'Aucun QR code trouvé' },
    it: { inclQr:'🔳 Metti un codice QR sull’immagine', qrNotice:'Scegli l’immagine salvata con “Carica da immagine” nella Mia pagina per importare questa ricetta (il QR contiene un link breve; viene omesso se il link non può essere creato, ad es. offline)', qrFooterTitle:'Apri questa ricetta dall’immagine', qrFooterText:'Salva l’immagine e scegliela con “Carica da immagine” nella Mia pagina di Lighting Recipe. Funziona anche scansionando il QR con la fotocamera del telefono.', qrSkipped:'Codice QR omesso (impossibile creare il link)', loadFromImage:'🖼 Carica da immagine', qrNotFound:'Nessun codice QR trovato' },
  ...
  const GEAR_NAMES = {
    ...
    en: { '白レフ':'Reflector (White)', '黒レフ':'Reflector (Black)', 'シルバーレフ':'Reflector (Silver)',
          ...
          'ヴィーナス像':'Venus Statue', '彫像（座像）':'Statue (Seated)', '彫像（有翼）':'Statue (Winged)',
          '観葉植物':'Potted Plant', '壁':'Wall', '壁（窓付き）':'Wall (Window)' },
    zh: { '白レフ':'白色反光板', '黒レフ':'黑色反光板', 'シルバーレフ':'银色反光板',
          'トランスルーセント':'柔光板', 'カポック（白）':'泡沫板（白）',
          'カポック（黒）':'泡沫板（黑）', 'フレネルレンズ':'菲涅尔透镜',
          'ヴィーナス像':'维纳斯像', '彫像（座像）':'雕像（坐像）', '彫像（有翼）':'雕像（带翼）',
          '観葉植物':'绿植', '壁':'墙', '壁（窓付き）':'墙（带窗）' },
    ko: { '白レフ':'반사판(흰색)', '黒レフ':'반사판(검정)', 'シルバーレフ':'반사판(은색)',
          'トランスルーセント':'디퓨저 패널', 'カポック（白）':'폼보드(흰색)',
          'カポック（黒）':'폼보드(검정)', 'フレネルレンズ':'프레넬 렌즈',
          'ヴィーナス像':'비너스상', '彫像（座像）':'조각상(좌상)', '彫像（有翼）':'조각상(날개)',
          '観葉植物':'관엽식물', '壁':'벽', '壁（窓付き）':'벽(창문)' },
    de: { '白レフ':'Reflektor (weiß)', '黒レフ':'Reflektor (schwarz)', 'シルバーレフ':'Reflektor (silber)',
          ...
          'ヴィーナス像':'Venusstatue', '彫像（座像）':'Statue (sitzend)', '彫像（有翼）':'Statue (geflügelt)',
          '観葉植物':'Zimmerpflanze', '壁':'Wand', '壁（窓付き）':'Wand (Fenster)' },
    fr: { '白レフ':'Réflecteur (blanc)', '黒レフ':'Réflecteur (noir)', 'シルバーレフ':'Réflecteur (argent)',
          ...
          'ヴィーナス像':'Statue de Vénus', '彫像（座像）':'Statue (assise)', '彫像（有翼）':'Statue (ailée)',
          '観葉植物':'Plante verte', '壁':'Mur', '壁（窓付き）':'Mur (fenêtre)' },
    it: { '白レフ':'Riflettore (bianco)', '黒レフ':'Riflettore (nero)', 'シルバーレフ':'Riflettore (argento)',
          ...
          'ヴィーナス像':'Statua di Venere', '彫像（座像）':'Statua (seduta)', '彫像（有翼）':'Statua (alata)',
          '観葉植物':'Pianta da interno', '壁':'Parete', '壁（窓付き）':'Parete (finestra)' },
    es: { '白レフ':'Reflector (blanco)', '黒レフ':'Reflector (negro)', 'シルバーレフ':'Reflector (plateado)',
          ...
          'ヴィーナス像':'Estatua de Venus', '彫像（座像）':'Estatua (sentada)', '彫像（有翼）':'Estatua (alada)',
          '観葉植物':'Planta de interior', '壁':'Pared', '壁（窓付き）':'Pared (ventana)' },
  };
