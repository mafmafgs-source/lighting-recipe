...
(function (global) {
  ...
  const I18N = {
    ...
    ja: {
      ...
      // builder.html
      cats:{strobe:'ストロボ',video:'ビデオライト',video_stick:'スティック型',modifier:'モディファイア',softbox:'ソフトボックス',umbrella:'アンブレラ',beauty_dish:'ビューティーディッシュ',snoot:'スヌート',grid:'グリッド',stand:'ライトスタンド',boom:'ブームアーム',reflector:'レフ板',flag:'Flag Frame',lens:'レンズ'},
    ...
    en: {
      ...
      cats:{strobe:'Strobe',video:'Video Light',video_stick:'Stick Light',modifier:'Modifier',softbox:'Softbox',umbrella:'Umbrella',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Grid',stand:'Light Stand',boom:'Boom Arm',reflector:'Reflector',flag:'Flag Frame',lens:'Lens'},
    ...
    zh: {
      ...
      cats:{strobe:'频闪灯',video:'视频灯',video_stick:'棒形灯',modifier:'附件',softbox:'柔光箱',umbrella:'伞',beauty_dish:'美颜碟',snoot:'束光筒',grid:'蜂窝罩',stand:'灯架',boom:'横臂',reflector:'反光板',flag:'遮光板',lens:'镜头'},
    ...
    ko: {
      ...
      cats:{strobe:'스트로브',video:'비디오라이트',video_stick:'스틱라이트',modifier:'모디파이어',softbox:'소프트박스',umbrella:'우산',beauty_dish:'뷰티디쉬',snoot:'스누트',grid:'그리드',stand:'라이트스탠드',boom:'붐암',reflector:'반사판',flag:'플래그프레임',lens:'렌즈'},
    ...
    de: {
      ...
      cats:{strobe:'Blitz',video:'Videoleuchte',video_stick:'Stableuchte',modifier:'Lichtformer',softbox:'Softbox',umbrella:'Schirm',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Grid',stand:'Lampenstativ',boom:'Galgenstativ',reflector:'Reflektor',flag:'Flag Frame',lens:'Objektiv'},
    ...
    fr: {
      ...
      cats:{strobe:'Flash',video:'Lampe vidéo',video_stick:'Tube lumineux',modifier:'Modeleur',softbox:'Softbox',umbrella:'Parapluie',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Grille',stand:'Pied d’éclairage',boom:'Bras déporté',reflector:'Réflecteur',flag:'Flag Frame',lens:'Objectif'},
    ...
    it: {
      ...
      cats:{strobe:'Flash',video:'Luce video',video_stick:'Luce a barra',modifier:'Modificatore',softbox:'Softbox',umbrella:'Ombrello',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Griglia',stand:'Stativo',boom:'Braccio',reflector:'Riflettore',flag:'Flag Frame',lens:'Obiettivo'},
    ...
    es: {
      ...
      cats:{strobe:'Flash',video:'Luz de video',video_stick:'Luz de barra',modifier:'Modificador',softbox:'Softbox',umbrella:'Paraguas',beauty_dish:'Beauty Dish',snoot:'Snoot',grid:'Rejilla',stand:'Soporte de luz',boom:'Brazo jirafa',reflector:'Reflector',flag:'Flag Frame',lens:'Objetivo'},
